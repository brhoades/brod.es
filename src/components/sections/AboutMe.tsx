...
export default () => (
  <React.Fragment>
    <p>
        I like programming--- no, seriously, I <em>like</em> programming. I program as a hobby: both after work and on the weekends. I am also passionate about good management; both above me and under me. Read <a href="https://blog.brod.es/management/2019/07/29/one-on-ones.html">my blog</a> about 1-on-1s and see how I tick.
    </p>
